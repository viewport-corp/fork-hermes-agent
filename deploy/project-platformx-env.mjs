...
const gatewayKeys = ["API_SERVER_KEY", "HERMES_AUTH_JSON_BOOTSTRAP", "HERMES_AUTH_JSON_REBOOTSTRAP", "HERMES_DASHBOARD_BASIC_AUTH_USERNAME", "HERMES_DASHBOARD_BASIC_AUTH_PASSWORD", "HERMES_DASHBOARD_DRAIN_SECRET", "HERMES_DASHBOARD_OAUTH_CLIENT_ID", "HERMES_DASHBOARD_OAUTH_CLIENT_SECRET", "HERMES_DASHBOARD_SESSION_TOKEN", "HERMES_INFERENCE_MODEL", "HERMES_INFERENCE_PROVIDER"];
